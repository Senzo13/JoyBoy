...
MCP_SERVER_TEMPLATES: dict[str, dict[str, Any]] = {
    ...
    "google-workspace-docs": {
        ...
        "description": "Expose Google Docs via Workspace MCP pour lire, créer et réviser des documents. Les credentials OAuth restent dans la config locale.",
    },
    "google-workspace-sheets": {
        ...
        "description": "Expose Google Sheets via Workspace MCP pour lire, modifier et analyser des tableurs. Les credentials OAuth restent dans la config locale.",
    },
    "google-workspace-slides": {
        ...
        "description": "Expose Google Slides via Workspace MCP pour créer, éditer et exporter des présentations. Les credentials OAuth restent dans la config locale.",
    },
    "google-workspace-gmail": {
        ...
        "description": "Expose Gmail via Workspace MCP pour lire, trier et préparer des brouillons. Les credentials OAuth restent dans la config locale.",
    },
    "canva": {
        "enabled": False,
        "type": "stdio",
        ...
        "env": {},
        "description": "Expose Canva via le serveur MCP officiel pour créer, chercher et exporter des designs. mcp-remote déclenche OAuth côté navigateur.",
    },
    "slack": {
        "enabled": False,
        "type": "http",
        ...
        "headers": {},
        "description": "Expose Slack via le Remote MCP officiel. Ajoute un token OAuth user local pour lire les canaux, résumer et préparer des réponses.",
    },
    "expo": {
        "enabled": False,
        "type": "stdio",
        ...
        "env": {},
        "description": "Expose Metro MCP pour inspecter et automatiser des apps React Native ou Expo pendant le développement local.",
    },
    "remotion": {
        "enabled": False,
        "type": "stdio",
        ...
        "env": {},
        "description": "Expose le MCP Remotion pour générer, inspecter et rendre des vidéos pilotées par code.",
    },
    "life-science": {
        "enabled": False,
        "type": "stdio",
        ...
        "env": {},
        "description": "Expose PubMed/NCBI via MCP pour rechercher des papiers, récupérer les métadonnées et produire une synthèse sourcée.",
    },
    "market-research": {
        "enabled": False,
        "type": "stdio",
        ...
        "description": "Expose Brave Search via MCP pour la recherche marché, les news, sociétés et signaux financiers publics.",
    },
    "postgres": {
        "enabled": False,
        "type": "stdio",
