...
def providers_status():
    ...
    from core.agent_runtime import get_llm_provider_catalog, get_mcp_runtime_status, get_terminal_model_profiles
    ...
    return jsonify({
        ...
        'mcp_runtime': get_mcp_runtime_status(load_tools=False),
...
@settings_bp.route('/api/mcp/config')
def mcp_get_config():
...
@settings_bp.route('/api/mcp/config', methods=['PUT'])
